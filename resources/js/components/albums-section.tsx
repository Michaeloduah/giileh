        ...
        <section className="bg-gradient-to-br from-red-300 to-gray-300 py-20">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    {albums.map((album) => (
                        <div key={album.id} className="group relative overflow-hidden rounded-2xl  bg-gradient-to-b from-red-700 to-black p-6 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
